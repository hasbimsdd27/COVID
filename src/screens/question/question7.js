                ...
                <View style={styles.container}>
                    <View style={styles.formCard}>
                        <Text style={{fontSize: 20}}>
                            Pada 14 Hari Terakhir sebelum Gejala, Apakah Anda
                            Memiliki Riwayat Perjalanan atau Tinggal di Luar
                            Negeri yang Terjangkit Covid-19 ? (China, Italy,
                            Iran, Spanyol, Jerman, Amerika, Prancis, Korea
                            Selatan, Inggris, Jepang (sumber : worldometers))
                        </Text>
                    </View>
                    <View style={styles.Button}>
                        <TouchableOpacity
                            activeOpacity={0.8}
                            onPress={() => {
                                this.props.addAnswer(7, 1),
                                    this.props.navigation.navigate('Question8');
                            }}>
                            <Text
                                style={{
                                    color: 'white',
